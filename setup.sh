...
python3 -m pip install --upgrade "jax[tpu]==0.3.6" -f https://storage.googleapis.com/jax-releases/libtpu_releases.html
...
python3 -m pip install wandb smart-open jsonpickle
